    ...
    var highlight = function(doc) {
        ...
        return function hightlight(o) {
            ...
            function hightlightTextNode(textNode) {
                var matchNode, wrapperNode, match, allMatch = true, text = textNode.data, matchesTable = [];
                _.each(regexTable, function(regex) {
                    if (regex.exec(text)) {
                        ...
                        text = text.substr(0, match.index) + getPipesString(match[0].length) + text.substr(match.index + match[0].length);
                    } else {
                        allMatch = false;
                        return false;
                    }
